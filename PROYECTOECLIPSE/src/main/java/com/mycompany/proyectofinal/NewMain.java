...
public class NewMain {
    ...
    public static void main(String[] args) throws PrecioErroneoException, NumberFormatException {
        ...
        // se empezarÃ¡ con 20 miembros de personal
        ...
        System.out.println("Con cuÃ¡nto dinero quieres empezar el juego? CuÃ¡l serÃ¡ el saldo inicial de tu hotel?");
        miHotel.setDineroHotel(Long.parseLong(sc.nextLine()));
        System.out.println("Nuestra plantilla inicial serÃ¡ de 20 empleados");
        
        do {
            try {
                System.out.println("Introduzca el precio por habitaciÃ³n para el dÃ­a de hoy \nRecuerde que el precio debe obscilar un mÃ­nimo de 50â‚¬ y un mÃ¡ximo de 100â‚¬");
                miHotel.setPrecio(Long.parseLong(sc.nextLine()));
            } catch (NumberFormatException ex) {
                System.out.println("Debes poner un valor nÃºmerico");
        ...
        System.out.println("CuÃ¡l serÃ¡ el nombre del hotel? ");
        miHotel.setNombre(sc.nextLine());
        miHotel.setHabitaciones(habitaciones);
        
        System.out.println("Este serÃ¡ nuestro hotel inicial ");
        System.out.println(miHotel.toString()); 
    	 */        
        
        // vamos a simular que un cliente pide un número de habitaciones al azar
        /*
